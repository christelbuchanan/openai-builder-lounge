...
### 1) `readme.md` — *Message Turn Sequence (runtime flow)*
...
1. **`system-architecture.md`** (what the components are)
2. **`readme.md`** (how a single turn runs end-to-end)
3. **`architecture-by-planes.md`** (how it scales/operates in production)
4. **`evals-harness.md`** (how you keep it from regressing)

## Optional next improvements (if you want a follow-up PR)
- Rename `readme.md` → `README.md` so GitHub renders it automatically.
- Add a short TOC + cross-links between the docs.
- Add a one-page “Glossary” (Thread, Router, Tool Policy, Receipts, TTFT, etc.).
